...
OPENPOCKETBASE_IMPLEMENT_STRUCT_STRING(OpenPocketBaseTextFieldRef, FOpenPocketBaseTextFieldRef)
...
OPENPOCKETBASE_IMPLEMENT_STRUCT_STRING(OpenPocketBaseGeoPointFieldRef, FOpenPocketBaseGeoPointFieldRef)
OPENPOCKETBASE_IMPLEMENT_STRUCT_STRING(OpenPocketBaseSingleSelectFieldRef, FOpenPocketBaseSingleSelectFieldRef)
OPENPOCKETBASE_IMPLEMENT_STRUCT_STRING(OpenPocketBaseMultipleSelectFieldRef, FOpenPocketBaseMultipleSelectFieldRef)
OPENPOCKETBASE_IMPLEMENT_STRUCT_STRING(OpenPocketBaseRelationFieldRef, FOpenPocketBaseRelationFieldRef)
OPENPOCKETBASE_IMPLEMENT_STRUCT_STRING(OpenPocketBaseSingleRelationFieldRef, FOpenPocketBaseSingleRelationFieldRef)
OPENPOCKETBASE_IMPLEMENT_STRUCT_STRING(OpenPocketBaseMultipleRelationFieldRef, FOpenPocketBaseMultipleRelationFieldRef)
